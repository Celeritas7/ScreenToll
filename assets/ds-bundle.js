...
})(); } catch (e) { __ds_ns.__errors.push({ path: "export/config.js", error: String((e && e.message) || e) }); }

// ui_kits/screen-toll-app/config.js
try { (() => {
// ScreenToll configuration — commit this file to your GitHub repo.
// Both values below are public-safe: Supabase row-level security and the
// operator list decide who gets in, not secrecy. Restrict the YouTube key
// by HTTP referrer in Google Cloud so only your site can spend its quota.
window.SCREENTOLL_CONFIG = {
  SUPABASE_URL: '',
  SUPABASE_ANON_KEY: '',
  YOUTUBE_API_KEY: '',
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/screen-toll-app/config.js", error: String((e && e.message) || e) }); }
